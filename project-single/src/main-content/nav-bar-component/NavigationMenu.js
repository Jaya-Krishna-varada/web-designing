...
class NavigationMenu extends React.Component {
    ...
    render() {
        return (
            <div class = "navbar bg-dark navbar-expand d=flex justify-content-between">
                <ul class = "navbar-nav">
                    <li className = {this.state.status["0"] ? "nav-item font-weight-bold bg-dark" : "nav-item"} onClick = {() => this.activeElement(0)}>
                        <a href = "#" class = "nav-link text-white d-flex flex-row">
                ...
                <ul class = "navbar-nav">
                    <li className = {this.state.status["3"] ? "nav-item font-weight-bold" : "nav-item"} onClick = {() => this.activeElement(3)}>
                        <a href = "#" class = "m-0 navbar-brand nav-link text-white d-flex flex-row">
